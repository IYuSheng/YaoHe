...
/* STM32 GPIO直接编码规则（PortX的基址+X引脚号）*/
#define PKG_ILI_9341_DC_PIN     0xC9    // PC9 → PortC=0x40, 9 → 0x40+9=0x49=73(十进制)
#define PKG_ILI_9341_RES_PIN    0xD2    // PD2 → PortD=0x60, 2 → 0x60+2=0x62=98(十进制)
#define PKG_ILI_9341_CS_PIN     0xC8    // PC8 → PortC=0x40,8 → 0x48=72(十进制)
#define PKG_ILI_9341_BLK_PIN    0xB0    // PB0 → PortB=0x20,0 → 0x20=32(十进制)
